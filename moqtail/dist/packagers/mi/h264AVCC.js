...
export const H264AVCCMetadataToExtensionHeader = (props) => {
...
export const deserializeH264AVCCMetadata = async (controlReader) => {
...
export const H264AVCCExtraDataToExtensionHeader = (props) => {
