...
import { audioDecoderConfigToExtensionHeader, videoDecoderConfigToExtensionHeader } from "../loc";
...
export const getMiExtensionHeaders = (type, config, chunk, seqId) => {
    let ret = [];
    ret.push({
    ...
    switch (type) {
        case MI_MEDIA_TYPE.H264AVCC:
            if (seqId === undefined)
                throw new Error('H264AVCC chunk must have seqId');
            const evChunk = chunk;
