...
export const serializeQuicVarInt = (value) => {
...
export const deserializeQuicVarInt = async (readableStream) => {
    let ret;
...
export const deserializeQuicVarIntFromArray = (data, offset = 0) => {
    ...
    if (size === 0) {
        ...
        value = Number((BigInt(data[offset] & 0x3f) << 56n) |
...
export const buffReadFromArray = (data, size, offset) => {
    if (size <= 0) {
        return null;
    }
...
export const stringToVarBytes = (str) => {
