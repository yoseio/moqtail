...
export const serializeFetchOk = (props: { subscribeId: number, groupOrder: number, endOfTrack: number, largestGroupId: number, largestObjectId: number, parameters?: ParameterTemp[] }) => {
