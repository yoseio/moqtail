...
export const serializeSubscribeUpdate = (props: { subscribeId: number, startGroup: number, startObject: number, endGroup: number, subscriberPriority: number, parameters: ParameterTemp[] }) => {
