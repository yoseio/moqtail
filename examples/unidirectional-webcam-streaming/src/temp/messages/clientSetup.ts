...
import { deserializeParams, serializeParams, type ParameterTemp } from "../utils/parameter";
import { concatBuffer, numberToVarInt, varIntToNumber } from "../utils/bytes";

export const serializeClientSetup = (props: { supportedVersions: number[], params?: ParameterTemp[] }) => {
