...
import { serializeParams, deserializeParams, type ParameterTemp } from '../utils/parameter';

export const serializeSubscribeAnnounces = (props: { trackNamespacePrefix: string[], parameters?: ParameterTemp[] }) => {
