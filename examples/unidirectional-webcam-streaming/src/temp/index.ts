...
export { serializeServerSetup, deserializeServerSetup, type ServerSetup } from './messages/serverSetup';
...
export { type ExtensionHeader, serializeExtensionHeader, deserializeExtensionHeader } from './dataStreams/extensionHeader';
